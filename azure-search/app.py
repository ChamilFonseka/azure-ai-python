...
def search_query(search_text, filter_by=None, sort_order=None):
    try:
        ...
        results =  search_client.search(search_text,
                                        ...
                                        select = "metadata_storage_name,metadata_author,metadata_storage_size,metadata_storage_last_modified,metadata_language,sentiment,merged_content,keyphrases,locations,imageTags,imageCaption")
        return results
